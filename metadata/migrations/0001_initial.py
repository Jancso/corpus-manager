# Generated by Django 2.2.5 on 2020-03-07 20:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(to='metadata.Participant')),
            ],
        ),
        migrations.CreateModel(
            name='Recording',
            fields=[
                ...
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='metadata.Session')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='languages',
            field=models.ManyToManyField(through='metadata.ParticipantLangInfo', to='metadata.Language'),
        ),
        migrations.CreateModel(
            name='File',
            fields=[
